...
public class PatientListingTest {
    ...
    @Test
    public void logoutPatientListingPage() {
        PatientListing patientListing = mainPage.registerUser("hr.doctor@hospitalrun.io", "HRt3st12");
        MainPage mainPage1 = patientListing.logOut();
        String text = mainPage1.getTextSignInForm();
        Assert.assertEquals("PLEASE SIGN IN",text);
